...
\thispagestyle{fancy}
\lhead{}
\chead{\scriptsize{(UNCLASSIFIED // FOR OFFICIAL USE ONLY)}}
\rhead{}
\lfoot{}
\cfoot{\vphantom{s}\vphantom{s}\vphantom{s}\scriptsize{(UNCLASSIFIED // FOR OFFICIAL USE ONLY)}}
\rfoot{}
%\renewcommand{\headrulewidth}{0.4pt}
%\renewcommand{\footrulewidth}{0.4pt}
%Classification is optional but probably a good idea
